...
import com.extensiblejava.facade.LoanFacade;
	...
	public void run() throws Exception {
		...
		if (display.toLowerCase().startsWith("p")) {
			...
			while (payments.hasNext()) {
				...
				interest += payment.getInterest().doubleValue();
				principal += payment.getPrincipal().doubleValue();
			}
			System.out.println("----------------------------");
			System.out.println(interest + "     " + principal + "\ntotal pay: " + (interest + principal));
		}
	}
}